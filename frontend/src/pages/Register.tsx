...
const Register = () => {
    ...
    onSuccess: async () => {
        showToast({message: "Registratiom Success!", type: "SUCCESS"});
    ...
    return (<form className="flex flex-col gap-5" onSubmit={onSubmit}>
        ...
        <div className=" flex flex-col md:flex-row gap-5">
            <label className="text-gray-700 text-sm font-bold flex-1">
                First Name
                <input className="border rounded w-full py-1 px-2 font-normal" {...register("firstName", {required: "This feild is required"})}></input>
                {errors.firstName && (
